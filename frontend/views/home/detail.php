                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            ...
                            <?php foreach ($good->gallery as $k=>$img):?>
                            <li <?=$k==0?'class="cur"':""?> >
                                <a <?=$k==0?'class="zoomThumbActive"':""?> href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$img->path."?imageView2/1/w/350/h/350"?>',largeimage: '<?=$img->path."?imageView2/1/w/800/h/800"?>'}"><img src='<?=$img->path."?imageView2/1/w/50/h/50"?>'></a>
                            </li>
<?php endforeach;?>
                        </ul>
                    </div>
