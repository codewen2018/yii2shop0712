...
<!--                        <img src="/images/checkcode1.jpg" alt="" />-->
                        <?=\yii\helpers\Html::img(['user1/captcha'],['id'=>'codeImg'])?>
...
<script type="text/javascript">
    ...
    $(function () {
        $(".login_btn").click(function () {
            console.log(11);
            //AjaxPost
               $.post('<?=\yii\helpers\Url::to(['reg'])?>',$("#regForm").serialize(),function (data) {
        ...
        $("#changeCode,#codeImg").click(function () {
            $.getJSON('<?=\yii\helpers\Url::to(["captcha","refresh"=>1])?>',function (data) {
              //找到codeImg
